...
class EmptyTree(unittest.TestCase):
    ...
    # """
    # Tests polling the first element from the TreeSet.
    #
    # This test would verify that the pollFirst method removes and returns the first element
    # in the TreeSet. (Currently not implemented)
    # """
